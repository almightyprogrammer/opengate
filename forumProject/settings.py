...
STATIC_URL = '/static/'  # Add a leading slash for consistency

STATICFILES_DIRS = [  # Use square brackets to define a list
    os.path.join(BASE_DIR, 'forumApp', 'static')  # Ensure this matches your actual structure
]
